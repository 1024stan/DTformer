...
from data.make_datasets import UHDCV_SequenceDataset
...
def model_test(args, model):
    ...
    test_loader = Data.DataLoader(
        UHDCV_SequenceDataset(data_path=args.data_path),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='DTformer-fine_tune', help='model of the experiment')
    # 数据集设置
    parser.add_argument('--batch_size', type=int, default=32, help='batch size')
    parser.add_argument('--num_workers', type=int, default=2, help='number work')
    parser.add_argument('--data_path', type=str, default='./data/fine_tune_data/train.txt', help='location of the data file')
    # 加载模型设置
    parser.add_argument('--trained_model_path', type=str, default='./saved_model/DTformer/DTformer_multi2021-12-26_06-12.pth', help='测试模型的路径')
    ...
    parser.add_argument('--max_epoch', type=int, default=2, help='最大迭代次数')
